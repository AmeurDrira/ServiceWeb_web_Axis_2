...
public class RestEasyTestClient {
	...
	public static void deleteEmployee(ResteasyClient client) {
		ResteasyWebTarget delete = client.target("http://localhost:8080/RestProject/employee/delete/1");
		Response deleteResponse =delete.request().delete();
		System.out.println(deleteResponse.readEntity(GenericResponse.class));
